...
public class TC000_GPN_BEEP_Application_Launch extends GPNBaseTest {

    @Factory(dataProvider = "accountRows", dataProviderClass = GPNBaseTest.class)
    public TC000_GPN_BEEP_Application_Launch(String companyUser, String companyPass,
    ...
    public void ApplicationTrigger(String companyUser, String companyPassword,
    	...
    	gpnBeepPageFinder();
    	new GPNBeepHomePage().selectBeepSetting().selectSearch().scrollTill().selectQrDropDown();
    }
}
